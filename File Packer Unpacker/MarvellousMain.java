...
class MarvellousLogin extends Template implements ActionListener , Runnable 
{
    ...
    MarvellousLogin()
    {
        ...
        TopLabel.setText("Arvind Packer Unpacker : Login Portal") ; 
        ...
        text1.setToolTipText("Enter Username : ") ; // Placeholder 
        ...
        text2.setToolTipText("ENTER PASSWORD") ; // Password Placeholder
        
        // used to perform some king of action when keyboard actions switches between the components 
    ...
    public void actionPerformed(ActionEvent ae )
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            ...
            if(value1.equals("Arvind#1010") && value2.equals("MessiIsGo@t1010"))
            {
