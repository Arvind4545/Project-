...
public class Server3
{
    public static void main(String A[]) throws Exception
    {
        ...
        BufferedReader br1 = new BufferedReader(new InputStreamReader(s.getInputStream())); // fromm client application 
        BufferedReader br2 = new BufferedReader(new InputStreamReader(System.in)); // from server application 
